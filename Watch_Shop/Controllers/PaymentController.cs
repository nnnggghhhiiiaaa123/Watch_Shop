...
namespace Watch_Shop.Controllers
{
    public class PaymentController : Controller
    {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (Session["User_ID"] == null)
                    {
                        ...
                        db.SaveChanges();
                        SendMail(f["Name"], f["Phone"], f["Email"], f["Address"], Total);
                    }
                    else
                    {
        ...
        public void SendMail(string Name, string Phone, string Email, string Address, decimal Total)
        {
        ...
        {
            var item = db.Discounts.SingleOrDefault(x => x.Discount_Name.Equals(value.Trim().ToUpper()));
